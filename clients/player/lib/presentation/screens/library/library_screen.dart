...
class _LibraryScreenState extends ConsumerState<LibraryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: _buildAppBar(title, icon),
  ...
  PreferredSizeWidget _buildAppBar(String title, IconData icon) {
    return PreferredSize(
      preferredSize: Size.fromHeight(_showSearch ? 120 : kToolbarHeight),
      child: ClipRRect(
  ...
  Widget _buildGridView(List items) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final topPadding = _showSearch ? 140.0 : 100.0;
